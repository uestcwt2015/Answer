	...
	return (
		<div style={mainStyle}>
			<form className="form" style={formStyle}>
				...
				<Button href="questionlist" className="button next-step-button" submit={true} url={"http://jcuan.org/user/registerTwo"} style={buttonStyle} linkStyle={linkStyle}>立即注册</Button>
			</form>
		</div>
	)
}
